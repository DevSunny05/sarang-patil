    ...
    <div name='contact' className='w-full h-fit bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
            {/* getform.io  work as a backend for your messeging*/}
            <form className='flex flex-col w-full md:w-1/2' action="https://getform.io/f/d2c2ad5d-52eb-40c9-8654-02476849ac68" method='post'>
